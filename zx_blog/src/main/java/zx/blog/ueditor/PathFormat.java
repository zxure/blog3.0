...
public class PathFormat {
	...
	public static String getWebAppName(String rootPath){
		logger.warn("rootPath:" + rootPath);
		logger.warn("File.pathSeparator:" + File.separator);
		int index = rootPath.lastIndexOf(File.separator, rootPath.length() - 2);
		return rootPath.substring(index, rootPath.length() - 1);
		
	}

	public static void main(String[] args) {
		System.out.println(getWebAppName("/usr/apache-tomcat/tomcat7/webapps/zx_blog/"));
